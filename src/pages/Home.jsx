        ...
        {!loading && error && (
          <div className="bg-rose-50 dark:bg-rose-950/20 border border-rose-100 dark:border-rose-900/40 rounded-3xl p-10 text-center max-w-md mx-auto my-8">
            ...
            <button 
              ...
              className="mt-5 bg-rose-650 hover:bg-rose-600 text-white font-bold text-xs px-5 py-2.5 rounded-xl transition-all duration-200 cursor-pointer shadow-md shadow-rose-600/10"
            >
              Try Again
            </button>
          </div>
